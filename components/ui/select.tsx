...
// Simple HTML Select for form libraries
...
const Select = ({
  ...
  const handleValueChange = (value: string) => {
    if (onChange) {
      // Convert string value to synthetic change event for form libraries
  ...
  // Extract onChange from props and pass the rest to SelectPrimitive.Root
